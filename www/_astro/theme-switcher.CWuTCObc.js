...
>
	...
	<path
		...
		fill="#FBA92C"
	/>
</svg>`;var W=Object.defineProperty,G=Object.getOwnPropertyDescriptor,S=(i,t,e,s)=>{for(var r=s>1?void 0:s?G(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=(s?n(t,e,r):n(r))||r);return s&&r&&W(t,e,r),r};const Q=[{name:"default",icon:N,label:"Classic"},{name:"dark",icon:V,label:"Dark"},{name:"chevalier",icon:J,label:"Chevalier"},{name:"collecteur",icon:H,label:"Collecteur"},{name:"sand",icon:K,label:"Sand"}];let f=class extends d{constructor(){super(...arguments),this._doc=document.firstElementChild,this.theme=null}_getCurrentTheme(){const i=localStorage.getItem("theme");i!==null?this._setTheme(i):window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?this._setTheme("dark"):this._setTheme("default")}firstUpdated(){this._getCurrentTheme()}_setTheme(i){this._doc.setAttribute("data-theme",i);const t=document.querySelector("#home-hero-image");i==="default"&&(t.src="/assets/images/home/classic-hero.jpg"),i==="dark"&&(t.src="/assets/images/home/dark-hero.jpg"),i==="chevalier"&&(t.src="/assets/images/home/chevalier-hero.png"),i==="collecteur"&&(t.src="/assets/images/home/collecteur-hero.png"),i==="sand"&&(t.src="/assets/images/home/sand-hero.jpg"),localStorage.setItem("theme",i),this.theme=i}render(){const i=l`${Q.map(t=>l`
